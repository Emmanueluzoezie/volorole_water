...
export const FirstComponent = () => {
  ...
  return (
      <div className={`h-[750px] text-gray-50 flex flex-col items-center justify-center border-b-2`} style={{ backgroundColor: appColor.primaryBgColor }}>
          <div className='text-center max-w-[900px] mx-auto px-4'>
              <h1 className='font-bold text-[28px] md:text-[36px]'>Volorole Water Solutions. Your One stop to water services</h1>
              ...
              <div className='md:flex justify-center items-center pt-[50px] px-14 md:px-0 text-xl md:text-2xl font-bold'>
                  <Link href="/contact" className='w-full'>
                      <button className='p-2 px-[20px] rounded-md text-black w-full' style={{ backgroundColor: "#cefa82" }}>Contact us</button>
                  </Link>
